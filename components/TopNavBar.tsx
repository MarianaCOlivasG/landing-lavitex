        ...
        <div className="flex justify-between items-center w-full px-6 md:px-16 lg:px-24 py-4 max-w-7xl mx-auto">
          ...
          <div className="flex justify-end items-center gap-6 w-auto md:w-1/3">
            <div className="hidden sm:flex items-center gap-6">
              <a href="https://www.facebook.com/Lavitexdelcaribe/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-500 transition-colors" aria-label="Facebook">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://www.instagram.com/lavitexdelcaribe/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-500 transition-colors" aria-label="Instagram">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <button 
              className="md:hidden p-2 text-slate-500 hover:text-cyan-500 focus:outline-none"
      ...
      >
        <div className="p-6 flex flex-col h-full">
          <div className="flex justify-end mb-8">
            <button 
              className="p-2 text-slate-500 hover:text-cyan-500 focus:outline-none"
              onClick={() => setIsMobileMenuOpen(false)}
