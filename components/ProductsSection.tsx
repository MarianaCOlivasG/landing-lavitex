...
export default function ProductsSection() {
  return (
    <section className="w-full py-section-gap bg-surface">
      <div className="max-w-container-max mx-auto px-gutter md:px-16 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div>
            <span className="font-label-caps text-label-caps text-secondary uppercase tracking-[0.2em] mb-4 block">Product Lines</span>
            <h2 className="font-headline-md text-headline-md text-on-surface">Engineered for Excellence</h2>
          </div>
