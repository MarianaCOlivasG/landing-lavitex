...
export default function ContactSection() {
  return (
    <section id="contact" className="w-full py-section-gap bg-surface-container-lowest border-t border-surface-container-low">
      <div className="max-w-container-max mx-auto px-gutter md:px-16 lg:px-24 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="bg-surface p-10 rounded-DEFAULT shadow-[0_4px_20px_-4px_rgba(22,109,146,0.03)] border border-surface-container-low">
          <div className="mb-8">
            <h2 className="font-headline-md text-headline-md text-on-surface mb-2">Solicita una Consulta</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">Conecta con nuestros gerentes de cuenta comerciales para precios al por mayor y especificaciones técnicas.</p>
          </div>
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea className="w-full bg-surface-container-lowest border-0 border-b-2 border-outline-variant focus:border-primary focus:ring-0 px-0 py-3 text-on-surface font-body-md text-body-md transition-colors bg-transparent resize-none" placeholder="Describe tus necesidades de textiles comerciales..." rows={4}></textarea>
            </div>
